...
class DataSet:
    ...
    """
    def __init__(self, file_name: str, profession : str, area_name: str, columns_for_report: list[str]):
    ...
    def find_dynamics_for_city(self):
        ...
        for vacancy in self.list_vacancy:
            if vacancy.area_name == self.area_name:
...
if __name__ == '__main__':
    ...
    area_name = input(data_entry[2])

    dataSet = DataSet(file_name, profession, area_name,columns_for_report)
